...
const Footer = () => {
  ...
  return (
   <footer className="mt-8 mb-20 sm:mb-0 rounded-t-large flex flex-col bg-bg-sand sm:flex-row gap-8 sm:gap-0 w-full p-8 sm:p-4 justify-between items-center border-t ">
    <Link href={"/"}>
