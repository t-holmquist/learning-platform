...
const MobileTabNav = () => {
  ...
  return (
    // Mobile nav test
    <div className={`flex justify-center ${pathName == "/sign-in" && "hidden"}`}>
        <div className="sm:hidden w-10/12 flex justify-between items-center fixed bottom-4 px-6 py-4  rounded-full bg-bg-red border">
          <Link href={"/dashboard"}>
