...
export const ShowcaseVideo = () => {
  ...
  return (
    ...
    className='group col-span-4 row-span-6 border space-y-4 rounded-large p-6 bg-bg-green hover:border-primary transition-all'>
        ...
        <video id="video" onMouseEnter={() => {handlePlay()}} className="border bg-bg-green w-full group-hover:-translate-y-1 group-hover:shadow-primary transition-all rounded-large aspect-video" playsInline muted controlsList="nodownload nofullscreen noremoteplayback" width="400" disablePictureInPicture height="200" preload="auto">
